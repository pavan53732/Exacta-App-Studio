...
test.describe("Guardian Security Center", () => {
  ...
  test.describe("Job Objects - Process Isolation", () => {
    ...
    test("should display job in active jobs list", async () => {
      ...
      // Find our test job
      const testJob = page.locator(
        `[data-testid="job-item"]:has-text("${testJobName}")`,
      );
  ...
  test.describe("Capability Tokens", () => {
    ...
    test("should display token details", async () => {
      ...
      const activeBadge = page
        .locator('[data-testid="capability-item"] >> text=ACTIVE')
        .first();
    ...
    test("should validate capability token", async () => {
      ...
      const validateButton = page
        .locator('[data-testid="validate-token-btn"]')
        .first();
  ...
  test.describe("Firewall Rules (WFP)", () => {
    ...
    test("should show WFP stub mode notice", async () => {
      ...
      const stubNotice = page.locator(
        "text=WFP Manager is currently in stub mode",
      );
      await expect(stubNotice)
        .toBeVisible()
        .catch(() => {
