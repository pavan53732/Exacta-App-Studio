...
- A. Product & Principles: [Product principles](exacta-kb/01-principles/product-principles.md)
- B. Security & Trust: [Threat model](exacta-kb/02-security/threat-model.md)
- C. Core Architecture: [High-level architecture](exacta-kb/03-architecture/high-level-architecture.md)
- D. AI Interaction Pipeline: [AI contracts](exacta-kb/04-ai-pipeline/ai-contracts.md)
- E. Execution & Validation: [Execution gates](exacta-kb/05-execution-validation/execution-gates.md)
- F. Operations: [Operational limits](exacta-kb/06-operations/logging-audit-trail.md)
- G. Roadmap: [Roadmap](exacta-kb/07-roadmap/roadmap.md)
- H. Reference: [Glossary / error codes](exacta-kb/99-reference/error-codes.md)