...
| --- | --- | --- |
| File Operations | 0-25 pts | Deletions, bulk modifications |
| Dependency Changes | 0-20 pts | Added/removed dependencies |
| Refactoring Scope | 0-15 pts | Cross-file changes |
| Breaking Changes | 0-10 pts | API signature changes |
| Security Impact | 0-10 pts | Auth/crypto code touched |
| Code Complexity | 0-10 pts | Cyclomatic complexity |
| **Policy Boundary Impact** | **0-30 pts** | **Safety Policy ceiling crossing, System Path modification, enforcement subsystem changes** |
...
**Policy Boundary Impact Rule**

Any plan with **non-zero Policy Boundary Impact** SHALL be classified as **High Risk** (minimum score 66), regardless of other factors. This ensures capability escalation (shell, network, upgrade) and Safety Policy interactions cannot be "diluted" by low scores in other categories.
...
- [C3. Approval Gate Specification](../C%20System%20Core%20Specification/C3%20Approval%20Gate%20Specification%20a63e631886434139b3855fc4cae13915.md) — Gate pipeline and System-Level Plans
- [D2. Plan Model & Approval Semantics](../D%20AI%20Interaction%20Pipeline/D2%20Plan%20Model%20&%20Approval%20Semantics%20d65c7875e18b4373ac15bc50515444a7.md) — Plan validation and policy binding
